...
public class UpdateChecker implements ASyncCheckResult, UpdateCheckerResult {
    ...
    public static final String GITHUB_ROOT = "https://raw.githubusercontent.com/gbaldera/Yts/master/";
    public static final String GITHUB_RELEASES_ROOT = GITHUB_ROOT + "releases/";
    public static final String GITHUB_VERSIONS_FILE = GITHUB_ROOT + "versions.json";
